...
def return_pbd_v0_2(modality):
    filename_categories = 'list/categories_pbd_v0.txt'
    if modality == 'RGB':
        prefix = '{:06d}.jpg'
        root_data = '/mnt/data/old/liweijie/datasets'
        filename_imglist_train = 'list/train_list_v0_2.txt'
        filename_imglist_val = 'list/test_list_v0_2.txt'
    elif modality == 'Flow':
        pass
    return filename_categories, filename_imglist_train, filename_imglist_val, root_data, prefix    
...
def return_dataset(dataset, modality):
    dict_single = {'jester': return_jester, 'something': return_something, 'somethingv2': return_somethingv2,
                   ...
                   'pbd-v0.1': return_pbd_v0_1, 'ucf101': return_ucf101, 'pbd-v0.2': return_pbd_v0_2}
